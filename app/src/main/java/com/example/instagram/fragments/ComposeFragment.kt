...
//        Setup App logic
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Toast.makeText(requireContext(),"You have to take a picture before submitting your post", Toast.LENGTH_SHORT).show()
            }
        }
...
//    Create Post Object
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Send post to the server", Toast.LENGTH_SHORT).show()
            } else {
